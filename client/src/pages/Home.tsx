...
export default function Home() {
  ...
  const resetRosterMutation = trpc.imports.resetRoster.useMutation({ onSuccess: async () => { toast.success("Current roster cleared", { description: "The masterlist history was preserved for reference." }); await Promise.all([utils.students.list.invalidate(), utils.dashboard.byDate.invalidate(), utils.imports.masterlists.invalidate()]); } });
